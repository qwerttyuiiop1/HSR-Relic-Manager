...
import com.example.hsrrelicmanager.core.components.Pixel
import com.example.hsrrelicmanager.core.components.a
import com.example.hsrrelicmanager.core.components.b
import com.example.hsrrelicmanager.core.components.clamped
import com.example.hsrrelicmanager.core.components.g
import com.example.hsrrelicmanager.core.components.r
import com.example.hsrrelicmanager.core.ext.toBitmap
...
class Overlay(
    ...
    private fun calc(top: Pixel, out: Pixel): Pixel {
        ...
        // out.r * out.a + top.r * top_a = bot.r * bot.a
        // bot.r = (out.r * out.a + top.r * top.a) / bot.a
